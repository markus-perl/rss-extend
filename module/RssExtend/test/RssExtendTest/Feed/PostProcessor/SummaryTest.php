...
class SummeryTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testProcess ()
    {
        ...
        $expected = '<ul><li>ist ein langer Satz der eventuell gekürzt werden könnte und dann auch noch Sinn ergibt</li><li>wird dahingehend eine logische Trennung vorgenommen und versucht weniger wichtige Satzteile wegzulassen</li><li>Summary: 362 -> 189</li></ul>';
